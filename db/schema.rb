...
ActiveRecord::Schema.define(version: 20161228135547) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["owner_type", "owner_id"], name: "index_events_on_owner_type_and_owner_id", using: :btree
    t.index ["receiver_type", "receiver_id"], name: "index_events_on_receiver_type_and_receiver_id", using: :btree
    t.index ["sender_type", "sender_id"], name: "index_events_on_sender_type_and_sender_id", using: :btree
  end
